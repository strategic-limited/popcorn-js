(function( Popcorn ) {
  ...
  Popcorn.smart = function( target, src, options ) {
    var node = typeof target === "string" ? Popcorn.dom.find( target ) : target,
      ...
      wrappers = "HTMLVRViewVideoElement HTMLYouTubeVideoElement HTMLVimeoVideoElement HTMLSoundCloudAudioElement HTMLAdaptiveMediaElement HTMLNullVideoElement HTMLVideoElement HTMLAudioElement".split(" ");
